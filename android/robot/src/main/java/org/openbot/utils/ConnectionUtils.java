...
public class ConnectionUtils {
  ...
  //Metodo que crea un JSON a partir de un nombre y un valor
  public static JSONObject createStatus(String name, String value) {
    try {
      //Linea que crea un JSON a partir de un nombre y un valor
  ...
  //Crea un objeto JSON que representa el estado de ciertos parámetros.
  public static JSONObject getStatus(boolean loggingEnabled,
      boolean noiseEnabled, //Se encuentra registrado o no
